<div>
  ...
  if (isset($_POST['ubah'])) {
    ...
    $sql = "UPDATE tb_transaksi SET id_outlet='$id_outlet', kode_invoice='$kode_invoice',id_member='$id_member', tgl='$tgl', batas_waktu='$batas_waktu', tgl_bayar='$tgl_bayar', biaya_tambahan='$biaya_tambahan', diskon='$diskon', pajak='$pajak', status='$status', dibayar='$dibayar', id_user='$id_user' WHERE id_transaksi ='$id'";
    ...
    if (!$result) {
      ...
      echo '<script>alert("Data Berhasil Dibayar !!!");
window.location.href="index.php?page=transaksi"</script>';
  ...
  <!-- ambil data  -->
  <?php
  $query = mysqli_query($kon, "SELECT * FROM tb_transaksi WHERE id_transaksi='" . $_GET['id_transaksi'] . "'");
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="id_outlet" class="form-control" placeholder="ID OUTLET" required value="<?php echo $row['id_outlet']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label>KODE INVOICE</label>
                  <input type="text" name="kode_invoice" class="form-control" placeholder="KODE INVOICE" required value="<?php echo $row['kode_invoice']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label>ID MEMBER</label>
                  <input type="text" name="id_member" class="form-control" placeholder="ID MEMBER" required value="<?php echo $row['id_member']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label>TANGGAL</label>
                  <input type="date" name="tgl" class="form-control" placeholder="TANGGAL" required value="<?php echo $row['tgl']; ?>" readonly>
                </div>
                <div class="form-group">
                  <label>BATAS WAKTU</label>
                  <input type="date" name="batas_waktu" class="form-control" placeholder="BATAS WAKTU" required value="<?php echo $row['batas_waktu']; ?>" readonly>
                </div>
                <div class="form-group">
